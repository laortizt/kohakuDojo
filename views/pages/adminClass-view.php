					...
					<div class="row g-3">
						...
						<div class="col-6">
							...
							<div class="input-field-profile">
								<input type="text" name="classTopic">
							</div>
						</div>
						<div class="col-6">
							<label class="label-form">Tipo de Evento</label>
							<?php echo $insClass->list_events_controller() ?>
						</div>
						...
						<div class="col-6">
							...
							<select class="input-field-profile" id="classTimeInit" name="classTimeInit">
								<option>9:00</option>
								<option>10:00</option>
								<option>11:00</option>
								<option>12:00</option>
						...
						<div class="col-6">
							...
							<select class="input-field-profile" id="classTimeEnd" name="classTimeEnd">
								<option>11:00</option>
								<option>12:00</option>
								<option>13:00</option>
								<option>14:00</option>
