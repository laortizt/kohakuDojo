                    ...
                    <div class="profile">
                        ...
                        <div class="input-container">
                            ...
                            <i class="far fa-address-card"></i>
                                <input type="text" value="<?php echo $profile['accountDni']?>" name="dni-profile" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}"/>
                            </div>
                        </div>
                        <div class="input-container">                        
                        ...
                        <div class="input-container">                        
                            ...
                            <i class="fas fa-map-marker-alt"></i>
                                <input type="text" value="<?php echo $profile['accountAddress']?>" name="adress-profile" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}"/>
                            </div>
                        </div>
                        ...
                        <div class="input-container">
                            ...
                            <div class="input-field">
                                ...
                                <input type="email" value="<?php echo $profile['accountEmail']?>" required="" name="email-profile"/>
                            </div>
                        </div>
                        ...
                        <div class="input-container">
                            <label class="label">Genéro</label>
