		...
		<div class="card">
			<div class="card-content">
				...
				<div class="header-class">
					<h1 class="title">Clases Registradas</h1>
					...
					<div class="barra__buscador">
						...
						<form action="ajax/searchAjax.php" class="formulario" method="post" form-data="default" form-data="default" autocomplete="off" enctype="multipart/form-data">
							<div>
								<input type="hidden" name="search_page" id="search_page" value="adminAttendance">
								<input type="text" name="search_attendance" id="search_attendance" placeholder="Buscar nombre" value="<?= isset($_SESSION['searchAttendance']) ? $_SESSION['searchAttendance'] : '' ?>" class="text-search">
